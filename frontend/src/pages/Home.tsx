  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-[20%] right-[-15%] w-[500px] h-[500px] bg-pink-600/20 rounded-full blur-[100px] animate-pulse"
          style={{animationDelay: "1s"}}
        />
        <div
          className="absolute bottom-[-10%] left-[30%] w-[400px] h-[400px] bg-blue-600/20 rounded-full blur-[80px] animate-pulse"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center space-y-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
            <span className="text-white font-medium">AI-powered</span> code
            exploration. Understand any repository in{" "}
            <span className="text-purple-400 font-medium">minutes</span>, not
            hours.
          </p>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 md:gap-5 mt-4 text-sm">
            ...
            <div className="flex items-center gap-2 text-gray-400">
              <div className="w-7 h-7 rounded-full bg-pink-500/20 border border-pink-500/30 flex items-center justify-center text-pink-400 font-bold text-xs">
                2
              </div>
            ...
            {[
              {
                ...
                description:
                  "AST parsing for 10+ languages. Extract functions, classes, and dependencies automatically.",
                color: "purple",
              },
              {
                icon: (
                ...
                description:
                  "Interactive visualization showing how files connect. Understand architecture at a glance.",
                color: "pink",
              },
              {
                icon: (
                ...
                title: "AI Chat",
                description:
                  "Ask questions in plain English. Get instant answers with code references.",
                color: "blue",
              },
            ].map((feature) => (
              <div
              ...
              >
                <div
                  className={`inline-flex p-3 rounded-xl bg-${feature.color}-500/10 text-${feature.color}-400 mb-4 group-hover:scale-110 transition-transform`}
                >
                  {feature.icon}
                </div>
